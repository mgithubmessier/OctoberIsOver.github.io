import { Component, OnInit, OnChanges, AfterViewInit, Sanitizer, Input } from '@angular/core';
...
export class SocialMediasComponent implements OnInit, OnChanges, AfterViewInit {
  sanitizer: Sanitizer;
